/**
 * ordersCourseController.
 * @file ordersCourseController.js.
                ...
                */
                removeCourse: function (course) {
                    ...
                    var dialogOptions = _.extend({}, this.config.dialogOptions, {
                        templateUrl: '/template/orders/menu/courses/course/confirm-remove.tmpl',
                        resolve: {
                            data: function () {
                                return {
                                    course: course
